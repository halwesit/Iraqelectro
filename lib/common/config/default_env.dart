...
class DefaultConfig {
  ...
  static String appName = 'iraqlectro';
  ...
  static String countryCodeDefault = 'IQ';
  static String dialCodeDefault = '+964';
  static String nameDefault = 'Iraq';
  ...
  static List onBoardingData = [
    {
      'title': 'Welcome to iraqlectro',
      'image': 'assets/images/fogg-delivery-1.png',
      'desc': 'iraqlectro is on the way to serve you. '
    },
    {
